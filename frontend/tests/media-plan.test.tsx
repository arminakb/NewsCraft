...
it("shows ordered source assets, availability, assignments, and manual requirements", () => {
  ...
  expect(screen.getByText("First source image")).toHaveAttribute("data-testid", "direction-boundary")
  expect(screen.getByText("First source image")).toHaveAttribute("dir", "auto")
  expect(screen.getByText("Crop the verified source image")).toBeInTheDocument()
  expect(screen.getByText("Crop the verified source image")).toHaveAttribute("dir", "auto")
