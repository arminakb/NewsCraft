...
export function NewsroomShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="newsroom-shell min-h-screen min-w-0 overflow-x-clip bg-background text-sm text-foreground min-[900px]:grid min-[900px]:h-screen min-[900px]:grid-cols-[260px_minmax(0,1fr)] min-[900px]:overflow-hidden">
