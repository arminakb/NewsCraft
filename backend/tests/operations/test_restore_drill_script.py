...
def test_drill_override_removes_primary_ports_and_live_authority() -> None:
    ...
    assert override.count("TELEGRAM_ACCEPTANCE_FIXTURE_PATH: /acceptance-fixtures/telegram_public_album.html") == 2
    assert override.count("./backend/tests/fixtures:/acceptance-fixtures:ro") == 2
